...
${OBJECTDIR}/files/RFUtilsFiles.o: files/RFUtilsFiles.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/files/RFUtilsFiles.o files/RFUtilsFiles.cpp

${OBJECTDIR}/math/RFUtilsFinancial.o: math/RFUtilsFinancial.cpp
	${MKDIR} -p ${OBJECTDIR}/math
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/math/RFUtilsFinancial.o math/RFUtilsFinancial.cpp
...
${TESTDIR}/tests/RFUtilsFileTest.o: tests/RFUtilsFileTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RFUtilsFileTest.o tests/RFUtilsFileTest.cpp


${TESTDIR}/tests/RFUtilsFinancialTest.o: tests/RFUtilsFinancialTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RFUtilsFinancialTest.o tests/RFUtilsFinancialTest.cpp
...
${OBJECTDIR}/files/RFUtilsFiles_nomain.o: ${OBJECTDIR}/files/RFUtilsFiles.o files/RFUtilsFiles.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/files/RFUtilsFiles_nomain.o files/RFUtilsFiles.cpp;\
	else  \
...
${OBJECTDIR}/math/RFUtilsFinancial_nomain.o: ${OBJECTDIR}/math/RFUtilsFinancial.o math/RFUtilsFinancial.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/math/RFUtilsFinancial_nomain.o math/RFUtilsFinancial.cpp;\
	else  \
